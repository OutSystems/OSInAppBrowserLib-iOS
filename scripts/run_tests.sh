...
# Shared functions for testing OSInAppBrowserLib
...
PROJECT_NAME="${PROJECT_NAME:-OSInAppBrowserLib}"
SCHEME_NAME="${SCHEME_NAME:-OSInAppBrowserLib}"
XCODEPROJ_PATH="${XCODEPROJ_PATH:-OSInAppBrowserLib.xcodeproj}"
COVERAGE_TARGET_FILTER="${COVERAGE_TARGET_FILTER:-OSInAppBrowserLib}"
...
show_help() {
    ...
    echo "  PROJECT_NAME             Project name (default: OSInAppBrowserLib)"
    echo "  SCHEME_NAME              Xcode scheme (default: OSInAppBrowserLib)"
    echo "  XCODEPROJ_PATH           Path to .xcodeproj (default: OSInAppBrowserLib.xcodeproj)"
    echo "  COVERAGE_TARGET_FILTER   Target for coverage filtering (default: OSInAppBrowserLib)"
    echo ""
    echo "Examples:"
