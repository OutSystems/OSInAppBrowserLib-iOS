...
struct OSIABExternalRouterSpy: OSIABRouter {
    ...
    func handleOpen(_ url: String, dismissStyle: OSIABDismissStyle, viewStyle: OSIABViewStyle, _ completionHandler: @escaping (Bool) -> Void) {
...
struct OSIABSystemRouterSpy: OSIABRouter {
    ...
    func handleOpen(_ url: String, dismissStyle: OSIABDismissStyle, viewStyle: OSIABViewStyle, _ completionHandler: @escaping (UIViewController?) -> Void) {
